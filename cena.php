...
<!-- Encabezado -->
<div class="titulo2 container-fluid py-5">
  <div class="container text-white">
    <h1 class="display-2"><b>Tus Cenas</b></h1>
    <?php if ($es_admin): ?>
...
<div class="container">
    ...
    <form class="m-auto w-50 mt-4 mb-4" method="POST" enctype="multipart/form-data" action="insertar.php">
      ...
      <input type="hidden" name="tipo_receta" value="cena">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a class="btn btn-primary btn-sm" href="editar.php?id=<?php echo $id?>&tipo_receta=cena">Editar</a>  
            <a class="btn btn-danger btn-sm" href="eliminar.php?id=<?php echo $id?>&tipo_receta=cena" onclick="return confirm('¿Estás seguro de eliminar esta receta?')">Eliminar</a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
